...
namespace Atm
{
    public class CardHolder
    {
        ...
        public void AddSetNum(Action<string> method)
        {
           SetNum +=method;
        }

        public void AddSetLastName(Action<string> method)
        {
            SetLastName +=method;
        }
        ...
        protected virtual  void OnSetNum(int message)
        {
         ...
         protected virtual  void OnSetFirstName(string message)
        {
           SetFirstName?.Invoke(message);
        }
         protected virtual void OnSetLasttName(string message)
        {
